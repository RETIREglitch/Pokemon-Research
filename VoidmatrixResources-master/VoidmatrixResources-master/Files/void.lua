...
local mapId = {
	...
	Movement = {
		color = 'purple',
		number = {117, 177, 179, 181, 183, 185, 186, 187, 192, 393, 474, 475, 476, 477, 478, 479, 480, 481, 482, 483, 484, 485, 486, 487, 488, 489, 490, 496}
	},
	VoidExit = {
		color = 'yellow',
		number = {105, 114, 337, 461, 516}
	},
	Softlock = {
		color = 'red',
		number = {115, 150, 176, 178, 180, 182, 184, 188}
	},
	Dangerous = {
		color = '#ff4400ff',
		number = {174}
...
local xAddrOffset = 0x24A98
local yAddrOffset = 0x24AA0 
